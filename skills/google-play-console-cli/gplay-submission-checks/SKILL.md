...
description: Pre-submission validation for Google Play releases covering
  metadata, screenshots, bundle integrity, data safety, and policy compliance.
  Use when preparing a release to avoid rejections and catch issues before
  submitting.
x-source: tamtom/gplay-cli-skills
x-source-ref: refs/heads/main
x-source-path: skills/gplay-submission-checks
